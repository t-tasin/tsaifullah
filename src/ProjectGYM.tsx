              ...
              <ModalContent>
                ...
                <ModalBody paddingBottom={4}>
                  <H6>
                    ...
                    the AI-GYM Trainer is a dynamic Python application tailored
                    to monitor exercise progress in real-time. Integrating
                    OpenCV and Mediapipe, it processes live webcam footage,
                    detecting body poses, calculating joint angles, and tracking
                    repetitions – offering users an immediate visual on their
                    workout performance. Its modular architecture, consisting of
                    a video input processor and a pose detector, ensures
                    efficient performance, while the adaptability of the
                    framework enables tracking of varied exercises. Dive deeper
                    into its workings or customize it further here.
                  </H6>
